export const CONCIERGE_FLOW_REFERENCES = {
  ...
  shoppingSupport: "FLOW_SHOPPING_SUPPORT",
  careNavigation: "FLOW_CARE_NAVIGATION",
...
export const CONCIERGE_FLOW_REGISTRY: ConciergeFlowDefinition[] = [
  ...
  },
  {
    ...
    nextImplementationStep: "Expand provider/search integrations for groceries, meals, and product reputation checks.",
  },
  {
    reference: CONCIERGE_FLOW_REFERENCES.careNavigation,
    actionName: "Find care / residence",
    levels: ["main_category", "sub_action", "fast_help", "voice_handoff"],
    status: "ready",
    providerCategory: "personal_care",
    setupFocus: "personal_care",
    savedData: ["contact_channel"],
    tools: ["web_search", "phone_call", "email", "whatsapp", "operator_review"],
    firstQuestions: ["care_need", "care_type", "location_or_preference"],
    confirmationRule: "Confirm care need, care type, location/preferences, provider/search criteria, channel, and next step before contacting, saving, or booking.",
    nextImplementationStep: "Expand direct care provider integrations and residence comparison data.",
  },
  {
