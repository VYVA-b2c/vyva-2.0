...
replaceFlow(canonicalFlows, "concierge.administrative_support", {
  status: "pilot",
  displayName: "Concierge Request Intake",
  description:
    "Stage 10D Concierge Specialist slice for user-initiated Concierge request-intake, Trusted Help setup context, and shopping-context navigation only. The flow reuses existing Concierge surfaces and does not book, contact providers, send messages, create tasks, authorize payments, mutate caregiver rights, write memory, or execute real-world actions.",
  supportedTriggers: ["user"],
  supportedChannels: ["voice", "pwa", "touch", "text"],
  expectedInputKinds: ["free_text", "option"],
  requiredTools: [],
  ...
  uiScenes: [{
    ...
    purpose:
      "Primary Concierge request-intake scene for opening existing Concierge, Trusted Help setup, or shopping context without executing external actions.",
    supportedInstructionTypes: ["show_text_prompt", "show_summary", "show_choice_question", "clear_scene"],
  }],
  outcomes: [{
    outcomeId: "concierge.administrative_support.action_proposed",
    category: "action_proposed",
    description:
      "A supported existing Concierge navigation/context action was proposed for Orchestrator tool authorization.",
    terminal: false,
    allowedNextFlowIds: [],
    escalationRequirement: "none",
    followUpEligible: false,
    ...
    outcomeId: "concierge.administrative_support.fallback_to_legacy",
    category: "blocked",
    description:
      "The request is safety-sensitive, execution-heavy, cross-domain, unsupported, or outside the migrated Concierge slice and should preserve legacy or Safety routing.",
    terminal: true,
    allowedNextFlowIds: [],
    escalationRequirement: "none",
    followUpEligible: false,
  ...
  metadata: {
    task18Stage: "stage_10d_concierge_specialist",
    ...
    caregiverBoundaryUnchanged: true,
    operatorBoundaryUnchanged: true,
    scheduleBoundaryUnchanged: true,
    memoryBoundaryUnchanged: true,
    domainSupervisorRequired: false,
  },
});
replaceFlow(canonicalFlows, "social.community_connection", {
  status: "pilot",
  displayName: "Social Community Connection",
  description:
    "Stage 10E Social Support Specialist slice for user-initiated community and social-room navigation/context only. The flow reuses existing companion/social surfaces and does not contact people, grant caregiver permissions, create escalations, schedule outreach, write memory, or execute external actions.",
  supportedTriggers: ["user"],
  supportedChannels: ["voice", "pwa", "touch", "text"],
  expectedInputKinds: ["free_text", "option"],
  requiredTools: [],
  ...
  memoryPolicy: {
    ...
    prohibitedCategories: [
      "hidden_reasoning",
      "caregiver_private_data",
      "raw_social_support_speech",
      "mental_health",
      "caregiver_permissions",
      "health_data",
      "medication_data",
      "human_contact_details",
    ],
    permittedTargets: ["working_memory"],
    writeConfirmation: "always",
    retentionClassification: "none",
  ...
  outcomes: [{
    outcomeId: "social.community_connection.action_proposed",
    category: "action_proposed",
    description:
      "A supported existing community/social navigation action was proposed for Orchestrator tool authorization.",
    terminal: false,
    allowedNextFlowIds: [],
    escalationRequirement: "none",
    followUpEligible: false,
    ...
    outcomeId: "social.community_connection.fallback_to_legacy",
    category: "blocked",
    description:
      "The request is safety-sensitive, emotional-support, caregiver-permission, human-contact, Concierge, cross-domain, unsupported, or outside the migrated Social Support slice and should preserve legacy or neighboring-domain routing.",
    terminal: true,
    allowedNextFlowIds: [],
    escalationRequirement: "none",
    followUpEligible: false,
  ...
  metadata: {
    ...
    humanContactBoundaryUnchanged: true,
    medicationBoundaryUnchanged: true,
    brainCoachBoundaryUnchanged: true,
    scheduleBoundaryUnchanged: true,
    memoryBoundaryUnchanged: true,
    domainSupervisorRequired: false,
  },
