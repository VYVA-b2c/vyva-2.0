...
const SEEDS: PresentationSeed[] = [
  ...
  { id: "presentation.health.symptom_assessment.describe", familyId: "presentation.family.input.free_text", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.describe", input: "free_text", ui: ["show_text_prompt"], experience: "symptom_assessment", moment: "describe" },
  { id: "presentation.health.symptom_assessment.safety_check", familyId: "presentation.family.choice.yes_no", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.safety", input: "option", options: ["yes", "no"], ui: ["show_choice_question"], experience: "symptom_assessment", moment: "safety_check" },
  { id: "presentation.health.symptom_assessment.urgent_escalation", familyId: "presentation.family.safety.warning", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.safety", input: "option", options: ["emergency_help", "human_help"], ui: ["show_choice_question"], safetyCritical: true, experience: "symptom_assessment", moment: "urgent_escalation" },
  { id: "presentation.health.symptom_assessment.symptom_selection", familyId: "presentation.family.choice.single", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.details", input: "option", options: ["symptom", "other"], ui: ["show_choice_question"], experience: "symptom_assessment", moment: "symptom_selection" },
  { id: "presentation.health.symptom_assessment.severity", familyId: "presentation.family.input.scale", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.details", input: "option", options: ["one", "two", "three", "four", "five"], ui: ["show_scale"], experience: "symptom_assessment", moment: "severity" },
  { id: "presentation.health.symptom_assessment.onset", familyId: "presentation.family.input.free_text", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.details", input: "free_text", ui: ["show_text_prompt"], experience: "symptom_assessment", moment: "onset" },
  { id: "presentation.health.symptom_assessment.related_details", familyId: "presentation.family.input.free_text", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.details", input: "free_text", ui: ["show_text_prompt"], experience: "symptom_assessment", moment: "related_details" },
  { id: "presentation.health.symptom_assessment.review", familyId: "presentation.family.confirmation", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.review", input: "option", options: ["confirm", "go_back"], ui: ["show_confirmation"], experience: "symptom_assessment", moment: "review" },
  { id: "presentation.health.symptom_assessment.checking", familyId: "presentation.family.progress", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.review", ui: ["show_progress"], experience: "symptom_assessment", moment: "checking" },
  { id: "presentation.health.symptom_assessment.safest_next_step", familyId: "presentation.family.summary", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.guidance", ui: ["show_summary"], experience: "symptom_assessment", moment: "safest_next_step" },
  { id: "presentation.health.symptom_assessment.save_share_summary", familyId: "presentation.family.summary", flowId: "health.symptom_assessment", sceneId: "health.symptom_assessment.guidance", ui: ["show_summary"], experience: "symptom_assessment", moment: "save_share_summary" },

  { id: "presentation.wellbeing.support.summary", familyId: "presentation.family.summary", flowId: "wellbeing.support", sceneId: "wellbeing.support.main", ui: ["show_summary"], experience: "mental_wellbeing", moment: "support_summary" },
  { id: "presentation.wellbeing.support.checkin", familyId: "presentation.family.input.free_text", flowId: "wellbeing.support", sceneId: "wellbeing.support.main", input: "free_text", ui: ["show_text_prompt"], experience: "mental_wellbeing", moment: "optional_reflection" },
  { id: "presentation.wellbeing.support.safe_fallback", familyId: "presentation.family.error.safe_fallback", flowId: "wellbeing.support", sceneId: "wellbeing.support.main", input: "option", options: ["retry", "request_help"], ui: ["show_summary", "show_choice_question"], experience: "mental_wellbeing", moment: "safe_fallback" },
  ...
  { id: "presentation.concierge.request_intake", familyId: "presentation.family.introduction", flowId: "concierge.administrative_support", sceneId: "concierge.administrative_support.main", ui: ["show_text_prompt"], experience: "concierge", moment: "request_intake" },
  { id: "presentation.concierge.trusted_help_setup", familyId: "presentation.family.introduction", flowId: "concierge.administrative_support", sceneId: "concierge.administrative_support.main", ui: ["show_text_prompt"], experience: "concierge", moment: "trusted_help_setup" },
  { id: "presentation.concierge.shopping_context", familyId: "presentation.family.summary", flowId: "concierge.administrative_support", sceneId: "concierge.administrative_support.main", ui: ["show_summary"], experience: "concierge", moment: "shopping_context" },
  { id: "presentation.concierge.safe_fallback", familyId: "presentation.family.error.safe_fallback", flowId: "concierge.administrative_support", sceneId: "concierge.administrative_support.main", input: "option", options: ["retry", "request_help"], ui: ["show_summary", "show_choice_question"], experience: "concierge", moment: "safe_fallback" },

  { id: "presentation.social.community_connection.summary", familyId: "presentation.family.summary", flowId: "social.community_connection", sceneId: "social.community_connection.main", ui: ["show_summary"], experience: "community", moment: "community_home" },
  { id: "presentation.social.community_connection.rooms", familyId: "presentation.family.summary", flowId: "social.community_connection", sceneId: "social.community_connection.main", ui: ["show_summary"], experience: "community", moment: "social_rooms" },
  { id: "presentation.social.community_connection.activities", familyId: "presentation.family.summary", flowId: "social.community_connection", sceneId: "social.community_connection.main", ui: ["show_summary"], experience: "community", moment: "community_activities" },
  { id: "presentation.social.community_connection.safe_fallback", familyId: "presentation.family.error.safe_fallback", flowId: "social.community_connection", sceneId: "social.community_connection.main", input: "option", options: ["retry", "request_help"], ui: ["show_summary", "show_choice_question"], experience: "community", moment: "safe_fallback" },
