...
export const CROSS_APP_WORKFLOW_COMPLETION_AUDIT: CrossAppWorkflowAuditEntry[] = [
  ...
  },
  {
    ...
    blockers: [],
    nextImplementation: "Use the shared comparison panel whenever a replacement home-service provider is searched.",
    priority: "later",
  },
  {
    ...
    evidence: ["Care, residence, doctor, transport, home-service, and seller searches use one comparison contract with up to three options, explicit unknown facts, shortlist persistence, trusted-provider saving, and confirmation-safe contact preparation."],
    blockers: [],
    nextImplementation: "Add more verified accessibility and coverage data sources while keeping missing fields explicit.",
    priority: "later",
  },
  {
    ...
    blockers: [],
    nextImplementation: "Use the shared comparison panel for seller results and preserve watch alerts without exposing internal ranking scores.",
    priority: "later",
  },
  {
