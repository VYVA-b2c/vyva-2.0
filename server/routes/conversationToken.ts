...
const ROOM_AGENT_ENV_KEYS: Record<string, string[]> = {
  ...
  "morning-movement": [
    "ELEVENLABS_WELLNESS_COACH_AGENT_ID",
    "VITE_ELEVENLABS_WELLNESS_COACH_AGENT_ID",
...
const SOCIAL_AGENT_ENV_KEYS: Record<string, string[]> = {
  ...
  "amara-osei": ["ELEVENLABS_WELLNESS_COACH_AGENT_ID", "VITE_ELEVENLABS_WELLNESS_COACH_AGENT_ID", "ELEVENLABS_AGENT_AMARA_OSEI", "ELEVENLABS_SOCIAL_AGENT_AMARA_OSEI", "ELEVENLABS_SOCIAL_MORNING_MOVEMENT_AGENT_ID", "ELEVENLABS_MOVEMENT_SOCIAL_AGENT_ID"],
  amara: ["ELEVENLABS_WELLNESS_COACH_AGENT_ID", "VITE_ELEVENLABS_WELLNESS_COACH_AGENT_ID", "ELEVENLABS_AGENT_AMARA_OSEI", "ELEVENLABS_SOCIAL_AGENT_AMARA_OSEI", "ELEVENLABS_SOCIAL_MORNING_MOVEMENT_AGENT_ID", "ELEVENLABS_MOVEMENT_SOCIAL_AGENT_ID"],
...
const TOP_LEVEL_AGENT_ENV_KEYS: Record<string, string[]> = {
  ...
  "breathing-meditation": ["ELEVENLABS_WELLNESS_COACH_AGENT_ID", "VITE_ELEVENLABS_WELLNESS_COACH_AGENT_ID", "ELEVENLABS_MEDITATION_AGENT_ID", "ELEVENLABS_BREATHING_MEDITATION_AGENT_ID", "ELEVENLABS_BREATHING_AGENT_ID"],
  meditation: ["ELEVENLABS_WELLNESS_COACH_AGENT_ID", "VITE_ELEVENLABS_WELLNESS_COACH_AGENT_ID", "ELEVENLABS_MEDITATION_AGENT_ID", "ELEVENLABS_BREATHING_MEDITATION_AGENT_ID", "ELEVENLABS_BREATHING_AGENT_ID"],
  breathing: ["ELEVENLABS_WELLNESS_COACH_AGENT_ID", "VITE_ELEVENLABS_WELLNESS_COACH_AGENT_ID", "ELEVENLABS_MEDITATION_AGENT_ID", "ELEVENLABS_BREATHING_MEDITATION_AGENT_ID", "ELEVENLABS_BREATHING_AGENT_ID"],
