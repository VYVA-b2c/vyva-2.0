...
CREATE TABLE "triage_reports" (
	...
	"watch_signs" text[] DEFAULT '{}' NOT NULL,
	"profile_considerations" text[] DEFAULT '{}' NOT NULL,
	"vitals_notes" text[] DEFAULT '{}' NOT NULL,
	"scan_results" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"scan_notes" text[] DEFAULT '{}' NOT NULL,
	"bpm" integer,
