...
const COPY: Record<LanguageCode, {
  ...
  yourAnswer: string; correctAnswer: string; noAnswer: string; continue: string; tryAnother: string;
  moreActivities: string; complete: string; accuracy: string; time: string;
}> = {
  en: { study: "Remember these plans", studyHint: "Each person has different details.", startRecall: "Start recall", reset: "Clear your mind", resetHint: "Tap the numbers from lowest to highest.", resetTry: "Choose the next smallest number.", recall: "Recall the connections", question: "Question", notSure: "Not sure", review: "Review", remembered: "Connections remembered", missed: "Take another look", yourAnswer: "Your answer", correctAnswer: "Correct connection", noAnswer: "Not sure", continue: "Continue", tryAnother: "Try another", moreActivities: "More activities", complete: "Connections complete", accuracy: "Accuracy", time: "Time" },
  es: { study: "Recuerda estos planes", studyHint: "Cada persona tiene datos diferentes.", startRecall: "Empezar a recordar", reset: "Despeja la mente", resetHint: "Toca los números de menor a mayor.", resetTry: "Elige el siguiente número más pequeño.", recall: "Recuerda las conexiones", question: "Pregunta", notSure: "No estoy seguro", review: "Revisión", remembered: "Conexiones recordadas", missed: "Repasa estas conexiones", yourAnswer: "Tu respuesta", correctAnswer: "Conexión correcta", noAnswer: "No estoy seguro", continue: "Continuar", tryAnother: "Probar otra", moreActivities: "Más actividades", complete: "Conexiones completadas", accuracy: "Precisión", time: "Tiempo" },
  fr: { study: "Retenez ces projets", studyHint: "Chaque personne a des détails différents.", startRecall: "Commencer le rappel", reset: "Faites le vide", resetHint: "Touchez les nombres du plus petit au plus grand.", resetTry: "Choisissez le prochain nombre le plus petit.", recall: "Retrouvez les connexions", question: "Question", notSure: "Je ne sais pas", review: "Révision", remembered: "Connexions retenues", missed: "Revoyez ces connexions", yourAnswer: "Votre réponse", correctAnswer: "Bonne connexion", noAnswer: "Je ne sais pas", continue: "Continuer", tryAnother: "Essayer une autre", moreActivities: "Plus d'activités", complete: "Connexions terminées", accuracy: "Précision", time: "Temps" },
  de: { study: "Merken Sie sich diese Pläne", studyHint: "Jede Person hat andere Details.", startRecall: "Erinnerung starten", reset: "Kopf frei machen", resetHint: "Tippen Sie die Zahlen von klein nach groß.", resetTry: "Wählen Sie die nächstkleinere Zahl.", recall: "Verbindungen erinnern", question: "Frage", notSure: "Nicht sicher", review: "Rückblick", remembered: "Erinnerte Verbindungen", missed: "Noch einmal ansehen", yourAnswer: "Ihre Antwort", correctAnswer: "Richtige Verbindung", noAnswer: "Nicht sicher", continue: "Weiter", tryAnother: "Noch eine", moreActivities: "Mehr Aktivitäten", complete: "Verbindungen abgeschlossen", accuracy: "Genauigkeit", time: "Zeit" },
  it: { study: "Ricorda questi programmi", studyHint: "Ogni persona ha dettagli diversi.", startRecall: "Inizia a ricordare", reset: "Libera la mente", resetHint: "Tocca i numeri dal più piccolo al più grande.", resetTry: "Scegli il prossimo numero più piccolo.", recall: "Ricorda le connessioni", question: "Domanda", notSure: "Non sono sicuro", review: "Revisione", remembered: "Connessioni ricordate", missed: "Rivedi queste connessioni", yourAnswer: "La tua risposta", correctAnswer: "Connessione corretta", noAnswer: "Non sono sicuro", continue: "Continua", tryAnother: "Provane un'altra", moreActivities: "Altre attività", complete: "Connessioni completate", accuracy: "Precisione", time: "Tempo" },
  pt: { study: "Recorde estes planos", studyHint: "Cada pessoa tem detalhes diferentes.", startRecall: "Começar a recordar", reset: "Liberte a mente", resetHint: "Toque nos números do menor para o maior.", resetTry: "Escolha o próximo número mais pequeno.", recall: "Recorde as ligações", question: "Pergunta", notSure: "Não tenho a certeza", review: "Revisão", remembered: "Ligações recordadas", missed: "Reveja estas ligações", yourAnswer: "A sua resposta", correctAnswer: "Ligação correta", noAnswer: "Não tenho a certeza", continue: "Continuar", tryAnother: "Tentar outra", moreActivities: "Mais atividades", complete: "Ligações concluídas", accuracy: "Precisão", time: "Tempo" },
};
...
export default function ConnectionsGame({
  ...
  if (phase === "complete" && result) {
    ...
    const replayLevel = result.accuracy >= 80 ? nextLevel : plan.level;
    return (
      <div className="min-h-[100dvh] bg-[#FFF9F3]">
        <BrainGameCompletionDialog
          ...
          replayLabel={copy.tryAnother}
          anotherLabel={copy.moreActivities}
          onContinue={onOpenRecommended}
          onReplay={() => void onOpenSameGame(replayLevel)}
          onAnother={onBack}
      ...
      <section className="rounded-[26px] border border-[#E8DDF2] bg-white p-4 shadow-vyva-card sm:p-6">
        ...
        {phase === "review" && result ? (
          <div className="mt-6">
            ...
            <button type="button" onClick={() => setPhase("complete")} className="mt-5 min-h-[60px] w-full rounded-full bg-vyva-purple px-6 text-[20px] font-black text-white shadow-vyva-card">{copy.continue}</button>
          </div>
        ) : null}
      </section>
    </div>
