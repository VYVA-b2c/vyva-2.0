      ...
      <section className="mt-5 rounded-[26px] border border-vyva-border bg-[#FFF9F1] p-5 shadow-vyva-card">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-3 text-[18px] leading-[1.4] text-vyva-text-2">{t("brainGames.executiveFunction.subtitle")}</p>
          </div>
          <div className="flex h-[70px] w-[70px] flex-shrink-0 items-center justify-center rounded-[22px] bg-white shadow-vyva-card">
            <Layers size={34} className="text-vyva-purple" />
          </div>
        </div>
      </section>
          ...
          return (
            ...
            >
              <div className="flex h-full flex-col justify-between gap-4">
                ...
                <div>
                  <h2 className="text-[22px] font-semibold leading-[1.15] text-vyva-text-1">{t(game.titleKey)}</h2>
                  <p className="mt-2 line-clamp-2 text-[16px] leading-[1.35] text-vyva-text-2">{t(game.descriptionKey)}</p>
                </div>
