...
const LANDING_COPY: Record<LanguageCode, {
  ...
  en: {
    ...
    productActions: ["My Health", "My Mind", "Social Club", "24/7 Concierge"],
  ...
  es: {
    ...
    productActions: ["Mi salud", "Mi mente", "Club social", "Concierge 24/7"],
  ...
  fr: {
    ...
    heroSubtitle: "Un compagnon chaleureux pour la sante, les medicaments, l'esprit, le lien social et l'aide pratique, jour et nuit.",
    andMore: "Et plus",
    productLive: "En direct",
    productTalk: "Parler a VYVA",
    productActions: ["Ma sante", "Mon esprit", "Club social", "Concierge 24/7"],
  ...
  de: {
    ...
    productActions: ["Meine Gesundheit", "Mein Geist", "Social Club", "24/7 Concierge"],
  ...
  it: {
    ...
    productActions: ["La mia salute", "La mia mente", "Social Club", "Concierge 24/7"],
  ...
  pt: {
    ...
    productActions: ["A minha saude", "A minha mente", "Clube social", "Concierge 24/7"],
