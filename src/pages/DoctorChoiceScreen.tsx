...
const DoctorChoiceScreen = () => {
  ...
  const quickActions = useMemo(() => doctorChoiceQuickActionsFor({
    ...
    labels: {
      ...
      book_ride: t("health.doctorChoice.quickActions.bookRide", "Arrange ride"),
      book_rideSub: t("health.doctorChoice.quickActions.bookRideSub", "VYVA can arrange the ride."),
