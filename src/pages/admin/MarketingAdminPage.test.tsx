...
describe("MarketingAdminPage", () => {
  ...
  it("edits and deletes imported content assets", async () => {
    ...
    fireEvent.click(screen.getByTestId("button-marketing-preview-content-content-2"));
    expect(screen.getByTestId("marketing-content-action-feedback")).toHaveTextContent('Previewing "Partner post".');
    expect(screen.getByTestId("marketing-content-preview-open-content-2")).toHaveTextContent("Preview opened below the content library.");
    ...
    expect(screen.getByTestId("marketing-content-preview-panel")).toHaveClass("shadow-sm");
    ...
    expect(screen.getByTestId("marketing-content-action-feedback")).toHaveTextContent('Editing "Partner post".');
    expect(screen.getByTestId("marketing-content-editor-open-content-2")).toHaveTextContent("Editor opened below the content library.");
    ...
    expect(screen.getByTestId("marketing-content-editor-panel")).toHaveClass("shadow-sm");
