...
describe("CheckHowIFeelScreen voice and screen synchronization", () => {
  ...
  it("exposes the current symptom-assessment stage and both presentation scenes", async () => {
    ...
    expect(flow).toHaveAttribute("data-symptom-assessment-stage", "welcome");
    ...
    fireEvent.click(screen.getByTestId("button-checkin-start"));
    await screen.findByText("How much energy do you have today?");
    expect(flow).toHaveAttribute("data-symptom-assessment-stage", "energy");
