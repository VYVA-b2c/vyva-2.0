const en = {
  ...
  meds: {
    ...
    dashboard: {
      ...
      personalGuidance: "Today's guidance",
      ...
      healthTipDiabetesBloodPressure: "For {{conditions}}: check medicines with meals, stand up slowly, and note dizziness or shakiness.",
      healthTipBloodPressure: "For blood pressure: stand up slowly and note dizziness, swelling, or headaches.",
      healthTipDiabetes: "For diabetes: pair medicine checks with meals and note shakiness or unusual thirst.",
      healthTipBloodThinner: "Because a blood thinner is on your list, watch for unusual bruising and ask before adding painkillers.",
      healthTipRespiratory: "For breathing support: keep inhalers easy to reach and note any new breathlessness.",
      healthTipStatin: "Because a cholesterol medicine is on your list, note new muscle pain or weakness.",
      healthTipConditionFallback: "For {{conditions}}: keep a quick note of how you feel after medicines.",
      healthTipGeneric: "Keep medicines in the routine your doctor gave you, and ask before adding supplements.",
      exerciseTipMobility: "Movement: seated ankle circles or slow sit-to-stand beside a steady chair.",
      exerciseTipDiabetesBloodPressure: "Movement: 5 minutes of easy walking or seated marching after a meal.",
      exerciseTipDiabetes: "Movement: a short gentle walk after a meal, stopping if you feel shaky.",
      exerciseTipBloodPressure: "Movement: steady walking or chair marching without holding your breath.",
      exerciseTipRespiratory: "Movement: a slow walk with pauses for relaxed breathing.",
      exerciseTipGardening: "Movement: water plants or walk the garden for 5 minutes, without bending too long.",
      exerciseTipGeneric: "Movement: 5 to 10 minutes of gentle walking or seated movement.",
