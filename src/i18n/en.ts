const en = {
  ...
  health: {
    ...
    symptomCheck: {
      ...
      chat: {
        ...
        optional: "Optional",
        readingHelper: "Use a device reading if you have one nearby. You can skip this.",
  ...
  memory: {
    ...
    visualTutorialLead: "Turn over two cards. Matching pictures stay open.",
    visualTutorialFirst: "Tap one card",
    visualTutorialSecond: "Tap a second card",
    visualTutorialFinish: "Keep matching until every pair is open",
    ...
    visualLevelReady: "Level complete. You can move on or stay here for another board.",
    visualRoundCounted: "Strong round. Keep going with a new board at this level.",
    visualStaySupport: "Stay here and strengthen this level. Take another calm round when you are ready.",
    visualMasteryComplete: "Mastery complete. Stay here and enjoy another strong round.",
  ...
  games: {
    ...
    rememberLater: {
      ...
      resultDetails: {
        ...
        reminderOnly0: "You touched the reminder button. Stay here and strengthen the target taps too.",
        reminderOnly1: "The reminder was there; this level will count when the matching improves too.",
        reminderOnly2: "You remembered the future action. Keep the purple target rule just as steady.",
      ...
      verdictMemoryCredit: "Reminder button remembered",
      verdictNotCounted: "Stay with this level",
      resultWhyCounted: "You used both buttons at the right time.",
      resultWhyMemoryCredit: "You touched the reminder button. Stay here and strengthen the target taps too.",
