const en = {
  ...
  meds: {
    ...
    primary: {
      ...
      refillsMobileSub: "Pharmacy refills",
  ...
  health: {
    ...
    master: {
      ...
      cards: {
        ...
        preventionReady: "Review ready",
      },
      fastHelp: {
        explainPlan: "Explain my plan",
        explainPlanDetail: "What matters today",
        openLatestReport: "Open latest report",
        openLatestReportDetail: "Reports and summaries",
        addVitals: "Add vitals",
        addVitalsDetail: "Blood pressure or pulse",
        reviewMedicine: "Review medicine",
        reviewMedicineDetail: "Doses and reminders",
        checkSymptoms: "Check symptoms",
        checkSymptomsDetail: "Tell VYVA what changed",
        doctorNote: "Doctor note",
        doctorNoteDetail: "Prepare what to say",
        shareSummary: "Share summary",
        shareSummaryDetail: "Open reports",
  ...
  games: {
    ...
    rememberLater: {
      ...
      subtitle: "We will give you something to remember. No hints.",
      cardBadge: "New",
      cardTitle: "Remember Later",
      cardDescription: "Remember a future action while you keep playing.",
      intentionEvent: "Remember: when you see the cue icon, tap the gold star.",
      intentionTime: "Remember: after a while, tap the gold star. We will not remind you.",
      noReminder: "We will not remind you again during the game.",
      tutorialBody: "While you play, watch the shapes. If you see the cue icon, tap the star. This example is the only time we guide you.",
      tutorialReady: "Ready to try it for real?",
      tryForReal: "Try it for real",
      ongoingRule: "Tap if it matches: {rule}",
  ...
  home: {
    master: {
      ...
      fastHelp: {
        askVyva: "Ask VYVA",
        askVyvaDetail: "Talk through anything",
        reviewToday: "Review today",
        reviewTodayDetail: "Open your plan",
        mindCheck: "Mind check",
        mindCheckDetail: "Memory or mood",
        joinCommunity: "Join community",
        joinCommunityDetail: "Rooms and activities",
        conciergeHelp: "Get concierge help",
        conciergeHelpDetail: "Errands or booking",
        callDoctor: "Call doctor",
        callDoctorDetail: "Prepare next step",
  ...
  mindMemory: {
    ...
    cards: {
      ...
      strengthenMemoryDetail: "Practice recall, matching, and daily routines.",
      trainReflexes: "Train Reflexes",
      trainReflexesDetail: "Build faster focus and response.",
      improveThinking: "Improve Thinking",
      improveThinkingDetail: "Challenge logic, planning, and problem solving.",
      sharpenSenses: "Sharpen Senses",
    ...
    fastHelp: {
      ...
      confusionPrompt: "I feel confused right now. Help me check what is safe to do next.",
      memoryOff: "Memory feels off",
      memoryOffDetail: "Open memory support",
      feelingLow: "Feeling low",
      feelingLowDetail: "Check in gently",
      sleepProblem: "Sleep problem",
      sleepProblemDetail: "Calm breathing",
      scamConcern: "Scam concern",
      scamConcernDetail: "Check before acting",
      medicationConfusion: "Medication confusion",
      medicationConfusionDetail: "Review medicines",
      talkCaregiver: "Talk to caregiver",
      talkCaregiverDetail: "Open care support",
      dailyRoutine: "Daily mind routine",
      dailyRoutineDetail: "Focus and calm",
    },
  },
  community: {
    master: {
      ...
      fastHelp: {
        ...
        joinRoomDetail: "Kitchen table",
        findMatch: "Find a match",
        findMatchDetail: "People and interests",
        morningMovement: "Morning movement",
        morningMovementDetail: "Gentle activity",
        musicRoom: "Music room",
        musicRoomDetail: "Songs and company",
        readingClub: "Reading club",
        readingClubDetail: "Stories and chat",
        gardenTable: "Garden table",
        gardenTableDetail: "Calm conversation",
        nearbyActivities: "Nearby activities",
        nearbyActivitiesDetail: "What is on",
        shareMemory: "Share a memory",
        shareMemoryDetail: "Post to a room",
      },
    },
  },
  concierge: {
    master: {
      ...
      cards: {
        help: "Help",
        helpDetail: "Home service, forms, legal/admin, care",
        ride: "Ride",
        rideDetail: "Now, later, medical transport",
        order: "Order",
        orderDetail: "Groceries, essentials, prepared meals",
        schedule: "Schedule",
        scheduleDetail: "Medical, government, personal care",
      },
      fastHelp: {
        homeService: "Home service",
        homeServiceDetail: "Repairs or help at home",
        fillForm: "Fill a form",
        fillFormDetail: "Prepare before submit",
        legalAdminHelp: "Legal/admin help",
        legalAdminHelpDetail: "Documents and options",
        findCare: "Find care",
        findCareDetail: "Compare care support",
        rideNow: "Ride now",
        rideNowDetail: "Compare immediate rides",
        rideLater: "Ride later",
        rideLaterDetail: "Plan pickup time",
        medicalTransport: "Medical transport",
        medicalTransportDetail: "Clinic-safe options",
        groceries: "Groceries",
        groceriesDetail: "Food shopping",
        essentials: "Essentials",
        essentialsDetail: "Household basics",
        preparedMeals: "Prepared meals",
        preparedMealsDetail: "Simple meal delivery",
        medicalSchedule: "Medical",
        medicalScheduleDetail: "Doctor or clinic",
        governmentSchedule: "Government",
        governmentScheduleDetail: "Official appointments",
        personalCareSchedule: "Personal care",
        personalCareScheduleDetail: "Hair, podiatry, wellness",
      },
    },
    fastHelp: {
