const en = {
  ...
  health: {
    ...
    master: {
      ...
      fastHelp: {
        ...
        findSpecialistDetail: "Right expert",
  ...
  activities: {
    ...
    relaxBreathe: {
      title: "Relax & Breathe",
      intro: "A guided calm pause. Tap once and VYVA leads you.",
      backToActivities: "Back to activities",
      backToMindMemory: "Back to Mind & Memory",
      duration: "Guided breathing",
      ...
      guideLive: "Voice guide is live",
      voiceRetry: "Voice was not available. The app guide is still running.",
      replay: "Repeat voice cue",
      back: "Back",
      next: "Next",
      finish: "Finish",
      ...
      tryAgain: "Try again",
      audioUnavailable: "The app guide still works without audio.",
      ...
      nowLabel: "Now",
      notStartedLabel: "Ready",
      runningLabel: "Guiding",
      pausedLabel: "Paused",
      timeLeft: "{n}s left",
      sessionProgress: "{n}% complete",
      nextLevelTitle: "Next time",
      visualMode: "App",
      voiceMode: "Voice",
      visualModeTitle: "App guide",
      visualModeBody: "The app moves through each breath for you.",
      voiceModeTitle: "Voice guide",
      voiceModeBody: "Marco can talk you through the breathing session.",
      levels: {
        easy: {
          title: "Easy",
          summary: "Simple in and out breathing.",
          duration: "About 1 minute",
        },
        steady: {
          title: "Steady",
          summary: "A slightly longer breath out.",
          duration: "About 1 minute",
        },
        deeper: {
          title: "Deeper",
          summary: "Adds a tiny comfortable pause.",
          duration: "About 1 minute",
        },
      },
      phases: {
        ...
        inhale: {
          title: "Breathe in",
          instruction: "Breathe in gently as the circle grows.",
          cue: "Easy breath in.",
        },
        exhale: {
          title: "Breathe out",
          instruction: "Let the breath out slowly as the circle settles.",
          cue: "Soft breath out.",
        },
        longExhale: {
          title: "Long breath out",
          instruction: "Breathe out a little longer, only while it feels comfortable.",
          cue: "Longer breath out.",
        },
        softPause: {
          title: "Soft pause",
          instruction: "Rest for a moment. Skip the pause if it does not feel good.",
          cue: "Tiny resting pause.",
        },
        return: {
          title: "Return gently",
