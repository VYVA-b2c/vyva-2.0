const en = {
  ...
  health: {
    ...
    findSpecialist: {
      ...
      experts: {
        ...
        amara: { label: "Wellness Coach", detail: "Movement and calm" },
  ...
  activities: {
    ...
    relaxBreathe: {
      ...
      startGuide: "Start VYVA guide",
      guideStarting: "Starting...",
      guideLive: "VYVA guide is live",
      replay: "Replay",
      back: "Back",
      next: "Next",
      finish: "Finish",
  ...
  wordRecall: {
    ...
    roundProgress: "Round {{round}} of {{total}}",
    chooseRemaining: "Choose up to {{count}} more.",
    selectionReady: "You have filled every place. Change a choice or continue.",
    selectionLimit: "Choose no more than {{count}} words.",
    nextRound: "Next round",
    seeResults: "See results",
    resultTitle: "You remembered {{remembered}} of {{total}}",
  ...
  games: {
    ...
    listenClosely: {
      ...
      instructionCompare: "Listen to both sounds. At the end, choose which one you heard more often.",
      instructions: "Instructions",
    ...
    rememberLater: {
      ...
      countedRoundIntro: "3 qualifying rounds in a row = next level.",
      qualificationRule: "A round counts when you catch the reminder, reach {overall}% overall, and {matching}% on matching.",
  ...
  brainGames: {
    ...
    dualTask: {
      ...
      tapMatch: "Tap = when both symbols match.",
      tutorialTitle: "How it works",
      skip: "Skip",
      ...
      resultPractice: "Keep practising. You are building this skill.",
      preparingResults: "Preparing your results...",
      progressRequirement: "Score 70% or more in 3 rounds in a row to move up. Progress: {count}/3.",
      maxLevelReached: "You have reached the highest level.",
      mathTask: "Math task",
  ...
  community: {
    master: {
      ...
      cards: {
        ...
        benefitsDetail: "You may be owed support",
  ...
  benefits: {
    ...
    talkToInes: "Talk to Inés",
    chatWithInes: "Chat with Inés",
    screenerEyebrow: "Quick check",
    screenerTitle: "Tell us about your situation",
    screenerBody: "This is a first check, not an official decision.",
    country: "Country",
    countries: { spain: "Spain", germany: "Germany" },
    region: "Region",
    regionHint: "Optional — add your autonomous community or federal state.",
    age: "Age",
    livingSituation: "Living situation",
    living: { alone: "I live alone", partner: "I live with a partner", family: "I live with family", careHome: "I live in supported care", other: "Something else" },
    current: "Support you already receive",
    currentHint: "Select any that apply. Leave blank if none apply.",
    currentPrograms: { esPnc: "Non-contributory pension", esImv: "Minimum Living Income", deGrundsicherung: "Basic income support in old age", deWohngeld: "Housing benefit" },
    check: "Check my benefits",
    checking: "Checking...",
    loadingTitle: "Checking available support",
    loadingBody: "We are comparing your answers with reviewed programmes.",
    error: "We could not check benefits right now. Please try again.",
    errorTitle: "We could not complete the check",
    tryAgain: "Try again",
    emptyTitle: "No reviewed matches yet",
    emptyBody: "Benefits content is added only after review. Inés can still help you understand what to check next.",
    resultsEyebrow: "Possible matches",
    resultsTitle: "Support worth checking",
    hideExplanation: "Hide explanation",
    readExplanation: "Read explanation",
    askInes: "Ask Inés about this",
  },
  concierge: {
    master: {
      ...
      cards: {
        getHelp: "Get Help",
        getHelpDetail: "Home repair, healthcare, admin, home care",
        getHelpChipHomeRepair: "Home Repair",
        getHelpChipHealthcare: "Healthcare",
        getHelpChipAdminService: "Admin Service",
        orderIn: "Order In",
        orderInDetail: "A ride, food, shopping",
        orderInChipRide: "A Ride",
        orderInChipFood: "Food",
        orderInChipShopping: "Shopping",
        bookAppointments: "Book Appointments",
        bookAppointmentsDetail: "Medical, admin, personal care",
        bookAppointmentsChipMedical: "Medical",
        bookAppointmentsChipAdmin: "Admin",
        bookAppointmentsChipPersonalCare: "Personal Care",
        discover: "Discover",
        discoverDetail: "Local services and offers",
        discoverChipSafeHome: "Safe Home",
        discoverChipCheckScam: "Check Scam",
        discoverChipOtcPharmacy: "OTC Pharmacy",
      },
      picker: {
        getHelp: {
          title: "Get Help",
          voiceContext: "Concierge help. Ask what kind of help the user needs and do not contact or book anyone without confirmation.",
          options: {
            ...
            homeCare: "Home Care",
            homeCareDetail: "Compare caregivers or care homes",
          },
        },
        bookAppointments: {
          title: "Book Appointments",
          voiceContext: "Concierge appointments. Ask what kind of appointment the user needs and do not book anything without confirmation.",
          options: {
            medical: "Medical",
            medicalDetail: "Doctor or clinic",
            admin: "Admin",
            adminDetail: "Government or official offices",
            personalCare: "Personal Care",
            personalCareDetail: "Hair, grooming, wellbeing",
            other: "Other",
            otherDetail: "Anything else to schedule",
          },
        },
        orderIn: {
          title: "Order In",
          voiceContext: "Concierge orders. Ask what the user needs and do not buy or contact anyone without confirmation.",
          options: {
            ride: "A Ride",
            rideDetail: "Transport help",
            food: "Food",
            foodDetail: "Groceries or a meal",
            shopping: "Shopping",
            shoppingDetail: "Household and everyday items",
            other: "Other",
            otherDetail: "Something else to order",
          },
        },
        discover: {
          title: "Discover",
          voiceContext: "Concierge discovery. Help the user browse local services and offers without contacting or booking anyone without confirmation.",
          options: {
            safeHome: "Safe Home",
            safeHomeDetail: "Safety check",
            checkScam: "Check Scam",
            checkScamDetail: "Message or offer",
            otcPharmacy: "OTC Pharmacy",
            otcPharmacyDetail: "Non-prescription items",
