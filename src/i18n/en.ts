const en = {
  ...
  home: {
    ...
    master: {
      ...
      touchOrbToBegin: "Touch the voice button to begin.",
      proactiveGreeting: {
      ...
      voiceSupport: "Tap the voice button to begin.",
      ...
      healthIntent: {
        ...
        dormantSubtitle: "Choose a health option, or touch the voice button.",
        voiceSubtitle: "Tell VYVA what you need, or touch the voice button.",
        symptoms: "Symptoms",
      ...
      mindIntent: { title: "What would you like to exercise?", more: "More mind activities", dormantSubtitle: "Choose an activity, or touch the voice button.", voiceSubtitle: "Tell VYVA what you want to exercise, or touch the voice button." },
      communityIntent: { title: "How would you like to connect?", more: "More community options", dormantSubtitle: "Choose a way to connect, or touch the voice button.", voiceSubtitle: "Tell VYVA how you want to connect, or touch the voice button." },
      conciergeIntent: { title: "What can VYVA help arrange?", more: "More concierge services", dormantSubtitle: "Choose a service, or touch the voice button.", voiceSubtitle: "Tell VYVA what you need arranged, or touch the voice button." },
      header: {
        health: "Health",
        display: "Display",
      },
  ...
  mindMemory: {
    ...
    cards: {
      ...
      boostFocus: "Boost Focus",
      boostFocusDetail: "Practice attention, planning, and problem solving.",
  ...
  statusVitals: {
    ...
    plan: {
      ageWellScore: "AgeWell Score",
      ageWellMissingBp: "Your biggest opportunity today: complete your heart picture.",
      ageWellDefaultMessage: "Your AgeWell plan is ready for today.",
      askVyva: "Ask VYVA",
      ...
      preventionSignal: "Prevention context",
      ...
      ageWellFallback: "Using a simple AgeWell plan until your latest prevention signals load.",
    },
  },
  informes: {
