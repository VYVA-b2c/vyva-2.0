const en = {
  ...
  games: {
    ...
    rememberLater: {
      ...
      tutorialGoldRule: "Tap the gold star when you see {cue}.",
      tutorialGoldWait: "Only use it for the reminder cue.",
      ...
      resultWhyMemoryCredit: "You got the gold star. Stay here and strengthen the target taps too.",
      resultWhyNeedsRecall: "Stay here and strengthen this level. Use purple for targets and gold for reminders.",
