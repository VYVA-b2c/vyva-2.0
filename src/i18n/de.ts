const de = {
  ...
  games: {
    ...
    rememberLater: {
      ...
      intentionEvent: "{cue}: goldenen Stern tippen.",
      intentionTime: "Spaeter: goldenen Stern tippen. Keine Erinnerung.",
  ...
  home: {
    ...
    master: {
      ...
      touchOrbToBegin: "Tippen Sie auf den Sprachknopf, um zu beginnen.",
      proactiveGreeting: {
      ...
      voiceSupport: "Tippen Sie zum Starten auf den Sprachknopf.",
      ...
      healthIntent: {
        ...
        dormantSubtitle: "Wahlen Sie eine Gesundheitsoption, oder tippen Sie den Sprachknopf an.",
        voiceSubtitle: "Sagen Sie VYVA, was Sie brauchen, oder tippen Sie den Sprachknopf an.",
        symptoms: "Symptome",
      ...
      mindIntent: { title: "Was möchten Sie trainieren?", more: "Mehr Denkaktivitäten", dormantSubtitle: "Wählen Sie eine Aktivität oder berühren Sie den Sprachknopf.", voiceSubtitle: "Sagen Sie VYVA, was Sie trainieren möchten, oder tippen Sie den Sprachknopf an." },
      communityIntent: { title: "Wie möchten Sie Kontakt aufnehmen?", more: "Mehr Gemeinschaftsoptionen", dormantSubtitle: "Wählen Sie eine Möglichkeit oder berühren Sie den Sprachknopf.", voiceSubtitle: "Sagen Sie VYVA, wie Sie Kontakt aufnehmen möchten, oder tippen Sie den Sprachknopf an." },
      conciergeIntent: { title: "Was darf VYVA organisieren?", more: "Mehr Concierge-Dienste", dormantSubtitle: "Wählen Sie einen Dienst oder berühren Sie den Sprachknopf.", voiceSubtitle: "Sagen Sie VYVA, was organisiert werden soll, oder tippen Sie den Sprachknopf an." },
      header: {
        health: "Gesundheit",
        display: "Anzeige",
      },
