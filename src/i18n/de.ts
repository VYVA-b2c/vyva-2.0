const de = {
  ...
  health: {
    ...
    dailyCheckin: {
      kicker: "Taglicher Wohlbefinden-Check",
      completed: "Heute erledigt",
      overdue: "Check-in uberfallig",
      due: "Jetzt bereit",
      setup: "Taglichen Check einrichten",
      upcoming: "Heute geplant",
      title: "Sag VYVA, wie du dich heute fuhlst",
      loadingMessage: "Ein kurzer taglicher Check hilft VYVA zu wissen, dass es dir gut geht.",
      completedAt: "Erledigt um",
      nextAt: "Nachster Check",
      defaultTime: "Standardzeit: 10:00",
      needsCaregiver: "Die Eskalation an Betreuungspersonen braucht einen Kontakt oder eine Freigabe.",
      history: "Verlauf",
      messages: {
        completed: "Du hast heute eingecheckt. VYVA hat ein neues Wohlbefinden-Signal.",
        dueNow: "Dein taglicher Check-in ist bereit. Eine kurze Antwort zeigt, dass alles in Ordnung ist.",
        overdueNeedsContact: "Der tagliche Check-in ist uberfallig. Fuge einen Betreuungskontakt hinzu oder bestatige ihn, damit VYVA bei Bedarf eskalieren kann.",
        overdueAlerted: "Der tagliche Check-in ist uberfallig, daher hat VYVA eine Sicherheitswarnung fur deine Betreuungsperson gespeichert.",
        upcoming: "Dein taglicher Check-in ist fur spater heute geplant.",
        notScheduled: "Lege eine tagliche Check-in-Zeit fest, damit VYVA merkt, wenn du nicht antwortest.",
      },
      actions: {
        primary: "Jetzt einchecken",
        viewHistory: "Verlauf ansehen",
        checkInEarly: "Frueher einchecken",
        setup: "Check einrichten",
      },
    },
    symptomCheck: {
      tracker: {
