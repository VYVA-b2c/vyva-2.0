const de = {
  ...
  memory: {
    ...
    visualTutorialLead: "Drehen Sie zwei Karten um. Gleiche Bilder bleiben offen.",
    visualTutorialFirst: "Eine Karte antippen",
    visualTutorialSecond: "Eine zweite Karte antippen",
    visualTutorialFinish: "Weitermachen, bis alle Paare offen sind",
    ...
    visualLevelReady: "Level geschafft. Sie können weitermachen oder hier ein neues Feld spielen.",
    visualRoundCounted: "Gute Runde. Spielen Sie auf diesem Level mit einem neuen Feld weiter.",
    visualStaySupport: "Bleiben Sie hier und festigen Sie dieses Level. Starten Sie in Ruhe eine neue Runde.",
    visualMasteryComplete: "Mastery abgeschlossen. Bleiben Sie hier und genießen Sie eine weitere starke Runde.",
