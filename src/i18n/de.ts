const de = {
  ...
  wordRecall: {
    ...
    roundProgress: "Runde {{round}} von {{total}}",
    chooseRemaining: "Wählen Sie noch bis zu {{count}} aus.",
    selectionReady: "Alle Plätze sind belegt. Ändern Sie eine Auswahl oder fahren Sie fort.",
    selectionLimit: "Wählen Sie höchstens {{count}} Wörter.",
    nextRound: "Nächste Runde",
    seeResults: "Ergebnisse ansehen",
    resultTitle: "Sie haben sich {{remembered}} von {{total}} gemerkt",
  ...
  brainGames: {
    ...
    dualTask: {
      ...
      tapMatch: "Tippe auf =, wenn beide Symbole gleich sind.",
      tutorialTitle: "So funktioniert es",
      skip: "Uberspringen",
      start: "Ubung starten",
      startAt: "Start bei",
      ...
      hits: "Treffer",
      almost: "Fast",
      visualDone: "Visuelle Aufgabe abgeschlossen",
      finishNumberTask: "Beende die Zahlenaufgabe oben, um deine Ergebnisse zu sehen.",
      resultGreat: "Fantastische Denkarbeit!",
      resultGood: "Gute Anstrengung! Diese Ubung ist anspruchsvoll.",
      resultPractice: "Weiter uben. Sie bauen diese Fahigkeit auf.",
      preparingResults: "Ergebnisse werden vorbereitet...",
      progressRequirement: "Erreiche mindestens 70% in 3 Runden in Folge, um aufzusteigen. Fortschritt: {count}/3.",
      maxLevelReached: "Du hast die hochste Stufe erreicht.",
  ...
  community: {
    master: {
      cards: {
        ...
        benefits: "Meine Leistungen",
        benefitsDetail: "Dir koennte Unterstuetzung zustehen",
      },
    },
  },
  benefits: {
    ...
    talkToInes: "Mit Inés sprechen",
    chatWithInes: "Mit Inés chatten",
    screenerEyebrow: "Schnellprüfung",
    screenerTitle: "Erzählen Sie uns von Ihrer Situation",
    screenerBody: "Dies ist eine erste Orientierung, keine amtliche Entscheidung.",
    country: "Land",
    countries: { spain: "Spanien", germany: "Deutschland" },
    region: "Region",
    regionHint: "Optional — geben Sie Ihre autonome Gemeinschaft oder Ihr Bundesland an.",
    age: "Alter",
    livingSituation: "Wohnsituation",
    living: { alone: "Ich lebe allein", partner: "Ich lebe mit meinem Partner oder meiner Partnerin", family: "Ich lebe mit meiner Familie", careHome: "Ich lebe in betreutem Wohnen", other: "Andere Situation" },
    current: "Unterstützung, die Sie bereits erhalten",
    currentHint: "Wählen Sie alles Zutreffende. Lassen Sie das Feld leer, wenn nichts zutrifft.",
    currentPrograms: { esPnc: "Beitragsunabhängige Rente", esImv: "Mindesteinkommen", deGrundsicherung: "Grundsicherung im Alter", deWohngeld: "Wohngeld" },
    check: "Meine Leistungen prüfen",
    checking: "Wird geprüft...",
    loadingTitle: "Verfügbare Unterstützung wird geprüft",
    loadingBody: "Wir vergleichen Ihre Antworten mit geprüften Programmen.",
    error: "Die Leistungen konnten gerade nicht geprüft werden. Bitte versuchen Sie es erneut.",
    errorTitle: "Die Prüfung konnte nicht abgeschlossen werden",
    tryAgain: "Erneut versuchen",
    emptyTitle: "Noch keine geprüften Treffer",
    emptyBody: "Leistungen werden erst nach der Prüfung angezeigt. Inés kann Ihnen trotzdem beim nächsten Schritt helfen.",
    resultsEyebrow: "Mögliche Treffer",
    resultsTitle: "Unterstützung, die Sie prüfen sollten",
    hideExplanation: "Erklärung ausblenden",
    readExplanation: "Erklärung lesen",
    askInes: "Inés dazu fragen",
  },
  informes: {
