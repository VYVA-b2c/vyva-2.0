...
export function SymptomChoiceCard({
  ...
  return (
    <button
      ...
      data-testid={testId}
      onClick={onClick}
      className={`symptom-canonical-choice group vyva-tap flex min-h-[68px] w-full items-center gap-3 rounded-[18px] border px-4 py-3 text-left shadow-[0_8px_22px_rgba(0,0,0,0.08)] transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#8B5CF6]/30 disabled:cursor-not-allowed disabled:opacity-55 [@media(max-height:800px)]:min-h-[60px] [@media(max-height:800px)]:py-2 ${isDark ? "border-white/[0.13] bg-[#352842] text-[#FFF8FF] hover:border-[#8B5CF6]/55 hover:bg-[#3D2D4B]" : "border-[#DED3E2] bg-white text-[#241238] hover:border-[#BFA2D8] hover:bg-[#FFFCFF]"}`}
    >
