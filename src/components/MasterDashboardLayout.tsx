  ...
  return (
    <div
      className={[
        ...
        isHomeMaster
          ? "mx-auto min-h-[calc(100svh-148px)] max-w-[calc(100vw-32px)] !px-0 pb-[100px] min-[390px]:max-w-[366px] sm:max-w-[520px] md:max-w-[640px]"
          : "",
      ].join(" ")}
      data-testid={testId}
    ...
    >
      ...
      >
          ...
          <span className={`min-w-0 flex-1 ${isHomeMaster ? "text-center" : "text-left"}`}>
            <h1
              className={[
                ...
                isHomeMaster
                  ? [
                      "mx-auto max-w-[19rem] font-body text-[21px] font-bold tracking-normal min-[390px]:text-[23px] sm:max-w-[28rem] sm:text-[28px] md:max-w-[34rem] md:text-[32px]",
            ...
            {hero.subtitle ? (
              <p
                className={[
                  ...
                  isHomeMaster ? "mx-auto !mt-1 text-[12px] font-extrabold text-[#E3A11B] min-[390px]:max-w-[20rem] min-[390px]:text-[13px] sm:text-[14px] md:text-[15px]" : "line-clamp-1 text-[15px] font-bold text-[#0F4C45] min-[390px]:text-[16px] sm:max-w-[18rem]",
        ...
        {isVoiceAction && isHomeMaster ? (
          <div className="relative mx-auto mt-4 w-[168px] min-[390px]:w-[184px] sm:w-[220px] md:w-[250px]">
            <VyvaSessionCta
              label={hero.action.label}
              activeLabel={hero.action.activeLabel}
              connectingLabel={hero.action.connectingLabel}
      ...
      {showLauncher ? <section className={isHomeMaster ? "mt-6 sm:mt-7 md:mt-8" : "mt-4"} aria-label="Today tray" data-testid={cardGridTestId}>
        {cardSectionTitle ? (
          <h2 className={isHomeMaster ? "sr-only" : "mb-3 font-body text-[15px] font-black leading-tight text-vyva-text-1"}>
            {cardSectionTitle}
          </h2>
        ) : null}
        <div className={isHomeMaster ? "grid grid-cols-2 gap-3 min-[390px]:gap-3.5 sm:gap-4 md:gap-5" : "grid grid-cols-2 gap-3 min-[390px]:gap-3.5 md:grid-cols-4"}>
            ...
            return (
              <button
                ...
                className={[
                  ...
                  isHomeMaster
                    ? "relative flex min-h-[92px] flex-col items-start justify-between rounded-[17px] p-3 shadow-[0_8px_18px_rgba(63,45,35,0.055)] min-[390px]:min-h-[100px] min-[390px]:rounded-[18px] min-[390px]:p-3.5 sm:min-h-[118px] sm:rounded-[22px] sm:p-4 md:min-h-[132px] md:p-5"
              ...
              >
                <span className={`flex min-w-0 flex-1 items-center gap-3 ${isHomeMaster ? "w-full items-start justify-between" : "md:w-full md:items-start md:justify-between"}`}>
                  <span
                    className={[
                      ...
                      isHomeMaster ? "h-7 w-7 rounded-[9px] min-[390px]:h-8 min-[390px]:w-8 sm:h-9 sm:w-9 md:h-10 md:w-10" : "h-14 w-14 min-[390px]:h-[60px] min-[390px]:w-[60px] md:h-[68px] md:w-[68px] md:rounded-[24px]",
                    ].join(" ")}
                ...
                <span className={`mt-3 min-w-0 pr-1 ${isHomeMaster ? "block" : "hidden md:block"}`}>
                  <span className={isHomeMasterDark ? "block font-body text-[16px] font-extrabold leading-[1.06] !text-[#FFF8FF] min-[390px]:text-[17px] sm:text-[19px] md:text-[22px]" : "block font-body text-[16px] font-extrabold leading-[1.06] text-vyva-text-1 min-[390px]:text-[17px] sm:text-[19px] md:text-[22px]"}>
                    {card.title}
                  </span>
