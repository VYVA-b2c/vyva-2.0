...
export const TRIAGE_PROTOCOLS: Record<string, TriageProtocol> = {
  ...
  other: {
    ...
    doctorToday: [
      protocolRule(["main_chest_breathing", "main_neuro_fall", "main_infection", "sudden_worse_today", "after_medicine_surgery_fall", "took_extra_medicine", "missed_important_medicine", "new_medicine_side_effect", "strong", "worse", "new_symptoms", "not_drinking"], "doctor_today", "An unclear symptom that is new, worsening, linked to a high-risk body area, medication-related, or affecting intake should be checked.", "Un sintoma poco claro nuevo, que empeora, ligado a una zona de riesgo, medicacion o afecta ingesta debe revisarse.", "Talk to a doctor today if this feels unusual or unsafe.", "Habla con un medico hoy si esto se siente raro o inseguro."),
    ],
    doctor24_48: [
