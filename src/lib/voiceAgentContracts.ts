...
export const VOICE_AGENT_CONTRACTS: VoiceAgentContract[] = [
  ...
  },
  {
    ...
    requiredContextKeys: [
      ...
      "secret__voice_triage_tool_token",
      "language",
      "dr_ai_first_message",
      "next_best_conversation",
      "next_best_conversation_opening_cue",
    ...
    actionTypes: ["health.vitals_capture", "health.vitals_review", "health.doctor_support", "health.symptom_support", "health.daily_checkin", "reports.history"],
  ...
  },
  {
    ...
    actionTypes: ["meds.management", "meds.inventory_report", "meds.refill_request"],
  ...
  },
  {
    ...
    actionTypes: ["concierge.appointment_help", "concierge.home_service", "concierge.ride_booking", "concierge.order_request", "concierge.reminder", "concierge.task"],
  ...
  },
  {
    ...
    actionTypes: ["brain.activity", "brain.memory_game", "brain.relax_breathe", "brain.focus", "brain.learn", "brain.senses"],
  ...
  },
  {
    ...
    actionTypes: ["social.rooms", "social.companion_chat"],
