...
export const HERO_MESSAGES: HeroMessageDefinition[] = [
  {
    ...
    periods: ["morning"],
    copy: {
      es: { headline: "Buenos dias", headlineWithName: "Buenos dias, {name}", ctaLabel: "Pregunta a VYVA" },
      en: { headline: "Good morning", headlineWithName: "Good morning, {name}", ctaLabel: "Ask VYVA" },
      de: { headline: "Guten Morgen", headlineWithName: "Guten Morgen, {name}", ctaLabel: "VYVA fragen" },
      fr: { headline: "Bonjour", headlineWithName: "Bonjour, {name}", ctaLabel: "Demander a VYVA" },
      it: { headline: "Buongiorno", headlineWithName: "Buongiorno, {name}", ctaLabel: "Chiedi a VYVA" },
      pt: { headline: "Bom dia", headlineWithName: "Bom dia, {name}", ctaLabel: "Pergunte a VYVA" },
    },
  },
  {
    id: "home-afternoon",
    ...
    periods: ["afternoon"],
    copy: {
      es: { headline: "Buenas tardes", headlineWithName: "Buenas tardes, {name}", ctaLabel: "Pregunta a VYVA" },
      en: { headline: "Good afternoon", headlineWithName: "Good afternoon, {name}", ctaLabel: "Ask VYVA" },
      de: { headline: "Guten Tag", headlineWithName: "Guten Tag, {name}", ctaLabel: "VYVA fragen" },
      fr: { headline: "Bon apres-midi", ctaLabel: "Demander a VYVA" },
      it: { headline: "Buon pomeriggio", ctaLabel: "Chiedi a VYVA" },
      pt: { headline: "Boa tarde", headlineWithName: "Boa tarde, {name}", ctaLabel: "Pergunte a VYVA" },
    },
  },
  {
    id: "home-evening",
    ...
    copy: {
      es: { headline: "Buenas noches", headlineWithName: "Buenas noches, {name}", ctaLabel: "Pregunta a VYVA" },
      en: { headline: "Good evening", headlineWithName: "Good evening, {name}", ctaLabel: "Ask VYVA" },
      de: { headline: "Guten Abend", headlineWithName: "Guten Abend, {name}", ctaLabel: "VYVA fragen" },
      fr: { headline: "Bonsoir", headlineWithName: "Bonsoir, {name}", ctaLabel: "Demander a VYVA" },
      it: { headline: "Buona sera", headlineWithName: "Buona sera, {name}", ctaLabel: "Chiedi a VYVA" },
      pt: { headline: "Boa noite", headlineWithName: "Boa noite, {name}", ctaLabel: "Pergunte a VYVA" },
    },
  },
  {
