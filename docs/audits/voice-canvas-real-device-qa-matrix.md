...
Prepare sanitized artifact references first in `docs/audits/voice-canvas-real-device-evidence-packet.md`, then copy the matching reviewer/date and evidence notes into this matrix.
