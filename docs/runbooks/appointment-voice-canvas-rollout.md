...
5. Focus or refresh any open Canvas session and confirm the Canvas closes or hides without a write, booking, call, message, navigation, resubmission, or external action. Confirm an interrupted waiting request is never automatically resubmitted.
