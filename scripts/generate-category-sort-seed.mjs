...
const tierConfig = {
  ...
  11: { count: 30, switchAfter: 2, rules: ["semantic", "shape", "semantic"] },
  12: { count: 30, switchAfter: 2, rules: ["semantic", "color", "semantic"] },
  13: { count: 30, switchAfter: 2, rules: ["semantic", "size", "semantic"] },
  14: { count: 30, switchAfter: 2, rules: ["color", "semantic", "semantic"] },
  15: { count: 30, switchAfter: 2, rules: ["shape", "semantic", "semantic"] },
  16: { count: 30, switchAfter: 2, rules: ["semantic", "semantic", "size"] },
  17: { count: 30, switchAfter: 2, rules: ["semantic", "semantic", "shape"] },
  18: { count: 30, switchAfter: 2, rules: ["semantic", "semantic", "color"] },
  19: { count: 30, switchAfter: 2, rules: ["semantic", "semantic", "semantic"] },
  20: { count: 30, switchAfter: 2, rules: ["semantic", "semantic", "semantic"] },
};
...
-- 20 per tier x 20 tiers x 3 languages.
