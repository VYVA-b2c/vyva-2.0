...
if (args.includes("--help") || args.includes("-h")) {
  console.log(
    [
      ...
      "Validation requires a non-future reviewed date generated within the last 7 days, no remaining placeholders, every launch flow, real physical device wording, concrete sanitized artifact references, and no emulator/responsive-mode evidence.",
...
const rejectedDeviceEvidencePatterns: readonly RegExp[] = [
  ...
  /\b(?:not tested|not real|unavailable|failed|unable to test|broken|crashed|blank screen|white screen)\b/i,
];
